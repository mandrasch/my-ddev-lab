...
ddev launch
</code></pre></div><p>Set the APP_URL to ddev project URL in .env, e.g. <code>APP_URL=https://ddev-statamic-blank.ddev.site</code></p><p>Add support for <code>please</code> command in <code>.ddev/commands/web</code>: <a href="https://github.com/mandrasch/ddev-statamic-blank/blob/main/.ddev/commands/web/please" target="_blank" rel="noopener noreferrer">https://github.com/mandrasch/ddev-statamic-blank/blob/main/.ddev/commands/web/please</a></p><p>Afterwards you can create your admin user:</p><div class="language-bash"><pre><code>ddev please make:user
ddev launch /cp
