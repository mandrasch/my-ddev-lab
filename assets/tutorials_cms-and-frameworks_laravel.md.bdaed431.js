...
</code></pre></div><p>And visiting <code>&lt;my-site&gt;.ddev.site:3000/@vite/client</code> results in <code>Fehlercode: SSL_ERROR_RX_RECORD_TOO_LONG</code> (Firefox).</p><h2 id="inertia" tabindex="-1">Inertia <a class="header-anchor" href="#inertia" aria-hidden="true">#</a></h2>`,22),i=a("ul",null,[a("li",null,[a("a",{href:"https://github.com/mandrasch/ddev-breeze-inertia-vue-starter",target:"_blank",rel:"noopener noreferrer"},"https://github.com/mandrasch/ddev-breeze-inertia-vue-starter")])],-1);function d(u,k,v,h,m,g){const n=o("TwoClickYoutubePrivacy");return r(),e("div",null,[l,t(n,{videoId:"XDn_itJ0s64"}),i])}var f=s(c,[["render",d]]);export{b as __pageData,f as default};
