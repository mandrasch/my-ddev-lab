...
</code></pre></div><h2 id="pull-content-media-files-from-production" tabindex="-1">Pull content / media files from production <a class="header-anchor" href="#pull-content-media-files-from-production" aria-hidden="true">#</a></h2><p>DDEV offers an incredible feature called <a href="https://ddev.readthedocs.io/en/stable/users/providers/provider-introduction/" target="_blank" rel="noopener noreferrer">Hosting Provider Integration</a>. This enables writing little scripts which can pull files from remote servers to your local development project.</p><p>Add these lines to your <code>.gitignore</code> file:</p><div class="language-bash"><pre><code><span class="token comment"># Don&#39;t store site specific content, we&#39;ll pull it from live site</span>
<span class="token comment"># (Comment these lines if you wan&#39;t to use Git automation)</span>
/content
/users
/public/assets
/storage/forms/
</code></pre></div><h3 id="git-strategy" tabindex="-1">Git strategy <a class="header-anchor" href="#git-strategy" aria-hidden="true">#</a></h3><p>To use push, we&#39;ll ignore the content folder in git locally:</p><p>Add <code>/content to </code>.gitignore\`</p><p>TODO: Add example</p>`,27),r=[o];function i(l,c,p,d,m,h){return t(),a("div",null,r)}var k=e(n,[["render",i]]);export{g as __pageData,k as default};
