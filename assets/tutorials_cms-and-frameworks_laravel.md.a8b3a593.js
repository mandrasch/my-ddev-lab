...
</code></pre></div><p>And visiting <code>&lt;my-site&gt;.ddev.site:3000/@vite/client</code> results in <code>Fehlercode: SSL_ERROR_RX_RECORD_TOO_LONG</code> (Firefox).</p><p>Also getting these warnings</p><div class="language-bash"><pre><code>/ddev-laravel-breeze-vite % ddev vite-serve start
...
</code></pre></div><h2 id="inertia" tabindex="-1">Inertia <a class="header-anchor" href="#inertia" aria-hidden="true">#</a></h2>`,24),i=a("ul",null,[a("li",null,[a("a",{href:"https://github.com/mandrasch/ddev-breeze-inertia-vue-starter",target:"_blank",rel:"noopener noreferrer"},"https://github.com/mandrasch/ddev-breeze-inertia-vue-starter")])],-1);function d(u,k,v,m,g,h){const n=o("TwoClickYoutubePrivacy");return r(),s("div",null,[l,t(n,{videoId:"XDn_itJ0s64"}),i])}var b=e(c,[["render",d]]);export{f as __pageData,b as default};
